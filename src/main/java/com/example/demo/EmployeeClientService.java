...
public class EmployeeClientService {
	...
	public EmployeeClientService(OAuth2AuthorizedClientManager authorizedClientManager,
	...
	public String getEmployees() {
		...
		return new RestTemplate()
				.exchange(apiUrl + "/employees", HttpMethod.GET, new HttpEntity<>(headers), String.class).getBody();
	}
	...
	private String getAccessToken() {
		OAuth2AuthorizeRequest authorizeRequest = OAuth2AuthorizeRequest.withClientRegistrationId("okta")
				.principal("EmployeeClient").build();
